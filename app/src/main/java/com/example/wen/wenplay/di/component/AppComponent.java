...
import com.example.wen.wenplay.di.module.RxDownloadModule;
...
@Singleton
@Component(modules = {AppModule.class, HttpModule.class, RxDownloadModule.class})
public interface AppComponent {
    ...
    public RxDownload getRxDowmload();

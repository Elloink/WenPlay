...
public class AppUtils {
    ...
    public static boolean installApk(Context context, String filePath) {
        ...
        Log.d("INSTALL","downloadDir:"+filePath);
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            Uri apkUri = FileProvider.getUriForFile(context, "com.example.wen.wenplay.fileprovider", file);

            Toast.makeText(context,"7.0开始安装",Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(context,"7.0以下开始安装",Toast.LENGTH_SHORT).show();
        }

        Toast.makeText(context,"执行了安装",Toast.LENGTH_SHORT).show();
    ...
    public static List<AndroidApk> getInstalledApps(Context context){
        ...
        List<AndroidApk> androidApks = new ArrayList<>(installedPackages.size());
